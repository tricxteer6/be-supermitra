...
function islandCaseSql() {
  return `
    CASE
      WHEN UPPER(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(TRIM(IFNULL(provinsi,'')),'PROVINSI',''),'.',''),' ','') ,'-',''),'_','')) REGEXP '^(ACEH|SUMATERAUTARA|SUMATERABARAT|RIAU|JAMBI|SUMATERASELATAN|BENGKULU|LAMPUNG|KEPULAUANBANGKABELITUNG|BANGKABELITUNG|KEPULAUANRIAU)$' THEN 'Sumatera'
      WHEN UPPER(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(TRIM(IFNULL(provinsi,'')),'PROVINSI',''),'.',''),' ','') ,'-',''),'_','')) REGEXP '^(BANTEN|DKIJAKARTA|JAKARTA|JAWABARAT|JAWATENGAH|DIYOGYAKARTA|DAERAHISTIMEWAYOGYAKARTA|YOGYAKARTA|JAWATIMUR|BALI|NUSATENGGARABARAT|NTB|NUSATENGGARATIMUR|NTT)$' THEN 'Jawa'
      WHEN UPPER(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(TRIM(IFNULL(provinsi,'')),'PROVINSI',''),'.',''),' ','') ,'-',''),'_','')) REGEXP '^(KALIMANTANBARAT|KALIMANTANTENGAH|KALIMANTANSELATAN|KALIMANTANTIMUR|KALIMANTANUTARA)$' THEN 'Kalimantan'
      WHEN UPPER(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(TRIM(IFNULL(provinsi,'')),'PROVINSI',''),'.',''),' ','') ,'-',''),'_','')) REGEXP '^(SULAWESIUTARA|SULAWESITENGAH|SULAWESISELATAN|SULAWESITENGGARA|GORONTALO|SULAWESIBARAT)$' THEN 'Sulawesi'
      WHEN UPPER(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(TRIM(IFNULL(provinsi,'')),'PROVINSI',''),'.',''),' ','') ,'-',''),'_','')) REGEXP '^(MALUKU|MALUKUUTARA)$' THEN 'Maluku'
      WHEN UPPER(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(TRIM(IFNULL(provinsi,'')),'PROVINSI',''),'.',''),' ','') ,'-',''),'_','')) REGEXP '^(PAPUA|PAPUABARAT|PAPUABARATDAYA|PAPUAPEGUNUNGAN|PAPUASELATAN|PAPUATENGAH)$' THEN 'Papua'
      ELSE 'Lainnya'
    END
  `;
}
